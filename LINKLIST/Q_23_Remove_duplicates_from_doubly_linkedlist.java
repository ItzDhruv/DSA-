...
public class Q_23_Remove_duplicates_from_doubly_linkedlist {
    ...
    public static void main(String[] args) {
        ...
        Q_23_Remove_duplicates_from_doubly_linkedlist dList = new Q_23_Remove_duplicates_from_doubly_linkedlist();
